...
@OnlyIn(Dist.CLIENT)
public class PeacefulSlimeOuterLayer<T extends LivingEntity> extends RenderLayer<T, PeacefulSlimeModel<T>> {
    private final EntityModel<T> model;

    public PeacefulSlimeOuterLayer(RenderLayerParent<T, PeacefulSlimeModel<T>> p_174536_, EntityModelSet p_174537_) {
        super(p_174536_);
